...
public class ListarAssistidosController {
    ...
    ResponseEntity<ListaAssistidoDTO> listarAssistidos(Pageable pageable){
        try {
            ...
            List<AssistidoSimplificadoDTO> assistidoDTO = assistidoMapper.convertEntitesToDtos(entities.getContent(), paramSort);
            assistidoResponse.setIsLastPage(lastPage);
            assistidoResponse.setAssistidos(assistidoDTO);
